...
//         const dto: StartSimulationEvent = {
//             repository: {
//                 git: {
...
//         await this.runnerService.runSimulation(new StartSimulationEvent());
//         const promise: Promise<ISimulation> = this.runnerService.runSimulation(new StartSimulationEvent());
